...
const getUserAddress = (firstName: string, lastName: string, email: string) =>
  `${firstName} ${lastName} <${email}>`;

export const getSecretaryNewUserEmail = (username: string) => ({
  ...
  `,
  html: `
    <p>A new guest account has been created: <a href="${process.env.FRONTEND_URL}/profile/${username}">${username}</a></p>

    <p>This email has been automatically generated.</p>
  `,
});

export const getUserNewAccountEmail = ({
  firstName,
  lastName,
  email,
  username,
...
export const getUserWelcomeEmail = ({
  email,
  firstName,
  lastName,
}: EmailInfo) => ({
...
export const getUserRejectionEmail = ({
  email,
  firstName,
  lastName,
  reason,
...
export const getUserWebsiteRegistrationEmail = ({
  email,
  firstName,
  lastName,
  resetToken,
  ...
  html: `
    ...
    <p>Please <a href="${process.env.FRONTEND_URL}/signup?token=${resetToken}">create your profile</a>.</p>

    <p>If you have any questions, please contact the <a href="mailto:webmaster@4-playersofcolorado.org">webmaster</a></p>
  `,
});

export const getUserEventRegistrationEmail = ({
  email,
  firstName,
  lastName,
  resetToken,
...
export const getUserAdminRegistrationEmail = ({
  email,
  firstName,
  lastName,
  resetToken,
...
export const getUserResetTokenEmail = ({
  email,
  firstName,
  lastName,
  username,
  ...
  html: `
    ...
    <a href="${process.env.FRONTEND_URL}/forgot-password?token=${resetToken}">Click here to reset your password</a></p>
  `,
});

export const getRunReminderEmail = (
  email: string,
  firstName: string,
  lastName: string,
  ...
  html: `
    ...
    <p>For more details or to edit your RSVP, please see <a href="${
      urlBase || process.env.FRONTEND_URL
...
export const getReportReminderEmail = (
  email: string,
  firstName: string,
  lastName: string,
  eventDetails: EventDetails,
...
export const getNotifyUserOfRestrictedStatusEmail = (
  email: string,
  firstName: string,
  lastName: string,
  events: EventDetails[],
...
export const getNotifyBoardOfDelinquentsEmail = (users: User[]) => {
...
export const getNotifyBoardOfInactiveMembersEmail = (users: RawUser[]) => {
  const usersMapText = users
    .map((user) => {
      return `
...
export const getNotifyUserOfRestrictedResetEmail = (
  email: string,
  firstName: string,
  lastName: string,
  max: number
...
export const getRemindWebmasterToSubscribeEmail = ({
  email,
  firstName,
  lastName,
  action,
...
export const getNotifyWebmasterOfMeetingEventsGeneration = () => ({
  to: webmasterAddress,
  from: noReplyAddress,
...
export const getMigrationEmail = ({
  email,
  firstName,
  resetToken,
}: {
...
export const getMigrationFollowupEmail = ({
  email,
  firstName,
  resetToken,
}: {
